...
#
  >**Document Description:** Write a brief (2-3 sentences) summary of the document's content. For example:
    ```
...
**Search similarity prompt:**
  ...
  <Step title="Using preview KB">
    
  #  
    

    You can easily test the knowledge base using the `Preview KB` feature built right into the knowledge tab of you agent. This lets you try out different `chunking options` and play around with different [AI models](AImodels). 
#
    >You can find it by navigating to the `knowledge` tab of your agent and look for **Preview KB** in the upper right.


  #
    <Accordion title="Example usage"> 
    <img class="rounded-md" src="https://i.imgur.com/EixOM8I.png" width="300"></img>
    </Accordion>
#
    **Interpreting the debug**

    


  <Accordion title="Example usage">
   <img class="rounded-md" src="https://i.imgur.com/H1H5gW6.png" width="300"></img> 
   </Accordion>
