...
<CardGroup cols={2}>
  ...
  <Card title="Task-Specific Guidance" icon="square-4">
    Clear instructions are provided on the AI's main task: suggesting recipes based on BakeMate's products and asking relevant questions to find the best recipe for the user.
  </Card>
